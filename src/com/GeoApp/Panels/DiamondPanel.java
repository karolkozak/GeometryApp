...
import com.GeoApp.Math.Diamond;

public class DiamondPanel extends JPanel implements ActionListener {
	
	private double a, diagonalLong, diagonalShort, acuteAngle, height, radius, area, perimeter;
	private JLabel labelImage, labelA, labelDiagonalLong, labelDiagonalShort, labelAcuteAngle, labelHeight,
	...
	private JPanel panelText, panelImage, panelA, panelDiagonalLong, panelDiagonalShort, panelAcuteAngle, panelHeight,
					panelRadius, panelArea, panelPerimeter, panelButton;
	private ApplicationToolBarFormat myToolBarFormat;
	
	public DiamondPanel(ApplicationToolBarFormat myToolBarFormat) {
	...
	private void createGUI() {
		...
		textAcuteAngle.addActionListener(this);
		...
		labelImage=new JLabel(new ImageIcon(getClass().getResource("/diamondImage.png")));
	...
	private void setTextFields(Diamond diamond) {
		...
		if(diamond.getA()!=-1) textA.setText(String.format(form,diamond.getA()));
		if(diamond.getPerimeter()!=-1) textPerimeter.setText(String.format(form,diamond.getPerimeter()));
		if(diamond.getDiagonalLong()!=-1) textDiagonalLong.setText(String.format(form,diamond.getDiagonalLong()));
		if(diamond.getDiagonalShort()!=-1) textDiagonalShort.setText(String.format(form,diamond.getDiagonalShort()));
		if(diamond.getRadius()!=-1) textRadius.setText(String.format(form, diamond.getRadius()));
		if(diamond.getHeight()!=-1) textHeight.setText(String.format(form, diamond.getHeight()));
		if(diamond.getArea()!=-1) textArea.setText(String.format(form,diamond.getArea()));
	}
