...
public class SquarePanel extends JPanel implements ActionListener {
	...
	private JLabel labelImage, labelA, labelDiagonal, labelArea, labelPerimeter;
	private JTextField textA, textDiagonal, textArea, textPerimeter;
	private JButton solve, reset;
	private JPanel panelText, panelImage, panelA, panelDiagonal, panelArea, panelPerimeter, panelButton;
	private ApplicationToolBarFormat myToolBarFormat;

	public SquarePanel(ApplicationToolBarFormat myToolBarFormat) {
	...
	private void createGUI() {
		...
		labelImage=new JLabel(new ImageIcon(getClass().getResource("/squareImage.png")));
	...
	private void setTextFields(Square square) {
		...
		if(square.getA()!=-1) textA.setText(String.format(form, square.getA()));
		if(square.getPerimeter()!=-1) textPerimeter.setText(String.format(form, square.getPerimeter()));
		if(square.getDiagonal()!=-1) textDiagonal.setText(String.format(form, square.getDiagonal()));
		if(square.getArea()!=-1) textArea.setText(String.format(form, square.getArea()));
	}
